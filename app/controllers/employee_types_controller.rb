  ...
  def create
    ...
    respond_to do |format|
      if @employee_type.save
        format.html { redirect_to new_employee_type_path, notice: 'Employee type was successfully created.' }
        format.json { render :new, status: :created, location: @employee_type }
      else
